...
function DeviceList({ devices }: { devices: TrustedDeviceViewModel[] }) {
  ...
  async function forget(deviceId: string) { try { setError(null); await appBridge.forgetDevice(deviceId); } catch { setError('This device could not be forgotten. Try again.'); } }
