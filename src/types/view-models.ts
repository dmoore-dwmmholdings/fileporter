...
export interface SettingsSnapshot { deviceName: string; receiveDirectory: string | null; onboardingComplete: boolean; launchAtLogin: boolean; notificationsEnabled: boolean; receivingEnabled: boolean; preferredListenAddress: string; preferredListenPort: number; historyRetentionDays: number; }
